...
function buildTable(theData) {
  // Clear out any existing theData
  tbody.html("");

  // Loop through each object in the theData
...
function buildCharts(theData) {
  ...
  // and store as array
  let key = "party";
  console.log(findOcc(theData, key));
  let arr3 = findOcc(theData, key);
  console.log(arr3);
  ...
  ///////////////////////// BAR CHART 2 ////////////////////////////
  var sTotal={};
  sTotal = theData.reduce((sTotal, object) => {
  ...
  key = "party";
  var key2 = "preds";
  let wlCounts = winLossCount(theData,key,key2);
